                        ...
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                ...
                                <div class="video_service_btn">
                                    <a href="#" class="-btboxedn3" style="text-transform: uppercase;"><i class="fa fa-user"></i> <?php echo $_SESSION['nama_petugas']?></a>
                                    <a href="#" class="btn btn-primary" style="text-transform: uppercase;"><?php echo $_SESSION['level']?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3>Admin/Petugas Web<br>
                                    Pengaduan Masyarakat</h3>
                                <div class="video_service_btn">
                                    <a href="#" class="btn btn-primary" style="text-transform: uppercase;"><i class="fa fa-user"></i> <?php echo $_SESSION['nama_petugas']?></a>
                                    <a href="#" class="btn btn-primary" style="text-transform: uppercase;"><?php echo $_SESSION['level']?></a>
                                </div>
